        ...
        <form @submit.prevent="updateItem(form.id)">
            ...
            <div class="flex flex-wrap -m-2">
                ...
                <div class="relative">
                    ...
                    <input type="radio" id="is_sellling" name="is_selling" v-model="form.is_selling" value="1" >
                    <label class="ml-2 mr-4">販売中</label>
                    <input type="radio" id="is_sellling" name="is_selling" v-model="form.is_selling" value="0" >
